...
import gr.aueb.cf.teacher.teacherapp.service.IRegionService;
import gr.aueb.cf.teacher.teacherapp.service.ITeacherService;
...
public class TeacherController {
    ...
    public String getTeacherForm(Model model) {
        ...
        model.addAttribute("regions", regionService.findAllRegions()); // populate combo box
